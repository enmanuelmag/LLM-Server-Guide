...
export const EMAIL_DATABASE: Omit<EmailData, 'embedding'>[] = [
  {
    ...
    content:
      'From: auto-confirm@amazon.com. Subject: Your order has been shipped. Dear Customer, your Amazon order #112-7854621-1234567 has been shipped. Item: Apple MacBook Pro 13-inch M2 chip. Price: $1,299.00. Shipping: FREE. Estimated delivery: Dec 15, 2024. Payment method: Visa ending in 4532. Shipping address: 123 Main St, Seattle, WA 98101.',
  ...
  },
  {
    ...
    content:
      'From: alerts@bankofamerica.com. Subject: Sign-in Alert for your account. We noticed a sign-in to your Bank of America account from a new device. Date: Dec 10, 2024 at 2:15 PM PST. Location: Seattle, WA. Device: iPhone Safari. If this was you, no action needed. If not, please contact us immediately at 1-800-432-1000.',
  ...
  },
  {
    ...
    content:
      'From: info@starbucks.com. Subject: ☕ Happy Birthday! Your free drink awaits. Happy Birthday! As a Starbucks Rewards member, enjoy ANY handcrafted beverage (any size) on us! This offer is valid for 30 days from your birthday. Redeem in-store or mobile app. Your current Stars balance: 340 Stars. You are 110 Stars away from your next reward!',
    category: 'promotion-offer',
  },
  {
    ...
    content:
      'From: service@paypal.com. Subject: You sent a payment to Microsoft Corporation. You sent $12.99 USD to Microsoft Corporation (microsoft@service.microsoft.com). Transaction ID: 8XY123456789ABC. Date: Dec 9, 2024. For: Microsoft 365 Personal Annual Subscription. Funding source: Bank of America checking account. Transaction fee: $0.00. Thanks for using PayPal!',
    category: 'subscription-charge',
  },
  {
