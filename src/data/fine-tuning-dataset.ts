  ...
  // Emails financieros - Facturas de proveedores
  {
    messages: [
      ...
      },
      {
        role: 'user',
        content:
          'Subject: Invoice #INV-2024-001 from TechCorp\nBody: Dear Customer, Your invoice #INV-2024-001 for $2,450.00 is now due. Payment terms: Net 30. Service: Software License. Please process payment by March 15, 2024.',
      },
      {
        role: 'assistant',
        content:
          '{"isFinancial": true, "confidence": 0.95, "category": "vendor-invoice", "reasoning": "Email contains invoice number, specific amount, and payment terms", "extractedAmount": {"value": 2450.00, "currency": "USD"}}',
      },
    ],
  },
  {
    messages: [
      ...
      },
      {
        role: 'user',
        content:
          'Subject: Payment Receipt - Office Supplies\nBody: Thank you for your purchase. Amount paid: $347.85. Items: Printer paper, pens, folders. Transaction ID: TXN-789456. Your order will be shipped within 2 business days.',
      },
      {
        role: 'assistant',
        content:
          '{"isFinancial": true, "confidence": 0.92, "category": "office-expense", "reasoning": "Contains payment confirmation with specific amount and transaction ID", "extractedAmount": {"value": 347.85, "currency": "USD"}}',
      },
    ],
  },
  ...
  // Emails financieros - Suscripciones
  {
    messages: [
      ...
      },
      {
        role: 'user',
        content:
          'Subject: Your Slack subscription renewal\nBody: Hi there! Your Slack Pro subscription has been renewed for $12.50/month. Next billing date: April 1st, 2024. Manage your subscription in your account settings.',
      },
      {
        role: 'assistant',
        content:
          '{"isFinancial": true, "confidence": 0.88, "category": "subscription-renewal", "reasoning": "Subscription renewal with monthly fee and billing date", "extractedAmount": {"value": 12.50, "currency": "USD"}}',
      },
    ],
  },
  {
    messages: [
      ...
      },
      {
        role: 'user',
        content:
          'Subject: Microsoft 365 Annual Subscription\nBody: Your Microsoft 365 Business subscription has been charged $1,200.00 for the annual plan. Subscription period: March 2024 - March 2025. Download your invoice from the admin portal.',
      },
      {
        role: 'assistant',
        content:
          '{"isFinancial": true, "confidence": 0.94, "category": "subscription-renewal", "reasoning": "Annual subscription charge with specific amount and period", "extractedAmount": {"value": 1200.00, "currency": "USD"}}',
      },
    ],
  },
  ...
  // Emails financieros - Gastos de viaje
  {
    messages: [
      ...
      },
      {
        role: 'assistant',
        content:
          '{"isFinancial": true, "confidence": 0.90, "category": "travel-expense", "reasoning": "Hotel booking with total cost and confirmation number", "extractedAmount": {"value": 380.00, "currency": "USD"}}',
      },
    ],
  },
  {
    messages: [
      ...
      },
      {
        role: 'user',
        content:
          'Subject: Flight Receipt - Business Trip\nBody: Flight receipt for Sarah Johnson. Route: NYC → SF → NYC. Total fare: $650.00. Flight dates: April 5-8, 2024. Expense report reference: EXP-2024-089.',
      },
      {
        role: 'assistant',
        content:
          '{"isFinancial": true, "confidence": 0.93, "category": "travel-expense", "reasoning": "Flight receipt with fare amount and expense report reference", "extractedAmount": {"value": 650.00, "currency": "USD"}}',
      },
    ],
  },
  ...
  // Emails NO financieros - Marketing
  {
    messages: [
      ...
      },
      {
        role: 'assistant',
        content:
          '{"isFinancial": false, "confidence": 0.85, "category": "marketing", "reasoning": "Product announcement email without specific financial transaction details"}',
      },
    ],
  },
  {
    messages: [
      ...
      },
      {
        role: 'assistant',
        content:
          '{"isFinancial": false, "confidence": 0.92, "category": "newsletter", "reasoning": "Newsletter content without any financial transaction information"}',
      },
    ],
  },
  ...
  // Emails NO financieros - HR/Admin
  {
    messages: [
      ...
      },
      {
        role: 'assistant',
        content:
          '{"isFinancial": false, "confidence": 0.95, "category": "meeting-admin", "reasoning": "Administrative email about team meeting without financial content"}',
      },
    ],
  },
  {
    messages: [
      ...
      },
      {
        role: 'assistant',
        content:
          '{"isFinancial": false, "confidence": 0.98, "category": "hr-onboarding", "reasoning": "HR onboarding email without any financial transaction content"}',
      },
    ],
  },
  ...
  // Emails borderline - Con menciones de dinero pero no transacciones
  {
    messages: [
      ...
      },
      {
        role: 'assistant',
        content:
          '{"isFinancial": false, "confidence": 0.70, "category": "budget-planning", "reasoning": "Mentions budget amounts but is about planning meeting, not actual transaction"}',
      },
    ],
  },
  {
    messages: [
      ...
      },
      {
        role: 'assistant',
        content:
          '{"isFinancial": true, "confidence": 0.85, "category": "expense-approval", "reasoning": "Request for expense approval with specific amount and expense details", "extractedAmount": {"value": 892.50, "currency": "USD"}}',
      },
    ],
  },
];
